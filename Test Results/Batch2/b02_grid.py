...
grid = {
    ...
    'coin': [('binance', 'ETHUSDT','usdm','last'),
            ('binance', 'BTCUSDT','usdm','last'),
            ('binance', 'ADAUSDT','usdm','last'),
            ('binance', 'TRXUSDT','usdm','last'),
            ('binance', 'LTCUSDT','usdm','last'),
            ('binance', 'BNBUSDT', 'usdm', 'last')
             ],
    ...
    'indicators': {'macd': {'timeframe': ['1hour'], 'fast_macd': list(map(int, np.arange(8, 16, 2))),
                   ...
                   'atr': {'timeframe': ['1hour'], 'lookback': list(map(int, np.arange(10, 22, 2)))},

                   'adx': {'timeframe': ['1hour'], 'lookback': [14]}},
    ...
    'trailing_stop': [{'trailing_volatility_stop': {'initial_value': 2}}],
