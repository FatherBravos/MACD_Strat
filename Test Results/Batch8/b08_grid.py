...
start_date, end_date = '2019-12-03T0000', '2023-05-30T0000'
...
grid = {
    ...
    'indicators': {'macd': {'timeframe': ['1hour'], 'fast_macd': list(map(int, np.arange(8, 15, 1))),
                            'slow_macd': list(map(int, np.arange(20, 31, 1))),
